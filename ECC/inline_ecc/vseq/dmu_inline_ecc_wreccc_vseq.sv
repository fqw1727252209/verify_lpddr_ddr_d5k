 ...
 * @Date: 2026-03-31 20:43:34
 * @LastEditors: fengqingwei
 * @LastEditTime: 2026-06-02 18:09:30
 * @Descripttion: 
 * @Version: 1.0
 * @Copyright (c) 2026 Phytium.co.Ltd
 */

class dmu_inline_ecc_wreccc_vseq extends dmu_base_vseq;

  `uvm_object_utils(dmu_inline_ecc_wreccc_vseq)
  ...
  function new(string name="dmu_inline_ecc_wreccc_vseq");
    super.new(name);
  endfunction
  ...
  virtual task body();
    ...
    // mr read test
    `uvm_info(get_full_name(), "Start dmu_inline_ecc_wreccc_vseq...", UVM_LOW)
    ...
    `uvm_info(get_full_name(), "dmu_inline_ecc_wreccc_vseq complete", UVM_LOW)
