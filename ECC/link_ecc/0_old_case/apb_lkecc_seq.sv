...
task apb_lkecc_seq::lkecc_cfg();
    ...
    for (int i=0; i<6; i++) begin
        if(ch_sel[i]==1) begin
            ...
            set_field_by_apb("CTL_RDLKECCENABLE", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_WRLKECCENABLE", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
            `uvm_info(get_full_name(), "LK ECC enabled for read and write", UVM_LOW);

            // Step 2: Enable error counters
            set_field_by_apb("CTL_RDLKECCUNCORRCNTEN", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_RDLKECCCORRCNTEN", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
            `uvm_info(get_full_name(), "LK ECC error counters enabled", UVM_LOW);

            // Step 3: Enable interrupts
            set_field_by_apb("CTL_RDLKECCUNCORRINTEN", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_RDLKECCCORRINTEN", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
...
task apb_lkecc_seq::lkecc_wr_err_inj(
    ...
    for (int i=0; i<6; i++) begin
        if(ch_sel[i]==1) begin
            ...
            set_field_by_apb("CTL_WRLKECCMASKINJECT2", mask_inject2_en, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_WRLKECCDATAINJECT2", data_inject2_en, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set WrLkeccMaskLaneInject2 and WrLkeccDataLaneInject2
            set_field_by_apb("CTL_WRLKECCMASKLANEINJECT2", mask_lane_inject2, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_WRLKECCDATALANEINJECT2", data_lane_inject2, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set WrLkeccMaskLocaInject2 and WrLkeccDataLocaInject2
            set_field_by_apb("CTL_WRLKECCMASKLOCAINJECT2", mask_loca_inject2, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_WRLKECCDATALOCAINJECT2", data_loca_inject2, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set WrLkeccMaskInject1 and WrLkeccDataInject1
            set_field_by_apb("CTL_WRLKECCMASKINJECT1", mask_inject1_en, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_WRLKECCDATAINJECT1", data_inject1_en, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set WrLkeccMaskLaneInject1 and WrLkeccDataLaneInject1
            set_field_by_apb("CTL_WRLKECCMASKLANEINJECT1", mask_lane_inject1, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_WRLKECCDATALANEINJECT1", data_lane_inject1, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set WrLkeccMaskLocaInject1 and WrLkeccDataLocaInject1
            set_field_by_apb("CTL_WRLKECCMASKLOCAINJECT1", mask_loca_inject1, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_WRLKECCDATALOCAINJECT1", data_loca_inject1, `CTL0_BASE_ADDR+i*'h0_0400);
...
task apb_lkecc_seq::lkecc_rd_err_inj(
    ...
    for (int i=0; i<6; i++) begin
        if(ch_sel[i]==1) begin
            ...
            set_field_by_apb("CTL_RDLKECCDBIINJECT2", dbi_inject2_en, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_RDLKECCDATAINJECT2", data_inject2_en, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set RdLkeccDbiLaneInject2 and RdLkeccDataLaneInject2
            set_field_by_apb("CTL_RDLKECCDBILANEINJECT2", dbi_lane_inject2, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_RDLKECCDATALANEINJECT2", data_lane_inject2, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set RdLkeccDbiLocaInject2 and RdLkeccDataLocaInject2
            set_field_by_apb("CTL_RDLKECCDBILOCAINJECT2", dbi_loca_inject2, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_RDLKECCDATALOCAINJECT2", data_loca_inject2, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set RdLkeccDbiInject1 and RdLkeccDataInject1
            set_field_by_apb("CTL_RDLKECCDBIINJECT1", dbi_inject1_en, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_RDLKECCDATAINJECT1", data_inject1_en, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set RdLkeccDbiLaneInject1 and RdLkeccDataLaneInject1
            set_field_by_apb("CTL_RDLKECCDBILANEINJECT1", dbi_lane_inject1, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_RDLKECCDATALANEINJECT1", data_lane_inject1, `CTL0_BASE_ADDR+i*'h0_0400);

            // Set RdLkeccDbiLocaInject1 and RdLkeccDataLocaInject1
            set_field_by_apb("CTL_RDLKECCDBILOCAINJECT1", dbi_loca_inject1, `CTL0_BASE_ADDR+i*'h0_0400);
            set_field_by_apb("CTL_RDLKECCDATALOCAINJECT1", data_loca_inject1, `CTL0_BASE_ADDR+i*'h0_0400);
...
task apb_lkecc_seq::lkecc_get_status(
    ...
    for (int i=0; i<6; i++) begin
        if(ch_sel[i]==1) begin
            ...
            get_field_by_apb("CTL_RDLKECCCORRCNT", rd_lkecc_corr_cnt, `CTL0_BASE_ADDR+i*'h0_0400);
            get_field_by_apb("CTL_RDLKECCUNCORRCNT", rd_lkecc_uncorr_cnt, `CTL0_BASE_ADDR+i*'h0_0400);
            `uvm_info(get_full_name(), $sformatf("RdLkeccCorrCnt=%0d, RdLkeccUncorrCnt=%0d",
                                                 rd_lkecc_corr_cnt, rd_lkecc_uncorr_cnt), UVM_LOW);

            // Read interrupt status
            get_field_by_apb("CTL_RDLKECCCORRINT", rd_lkecc_corr_int, `CTL0_BASE_ADDR+i*'h0_0400);
            get_field_by_apb("CTL_RDLKECCUNCORRINT", rd_lkecc_uncorr_int, `CTL0_BASE_ADDR+i*'h0_0400);
    ...
    for (int i=0; i<6; i++) begin
        if(ch_sel[i]==1) begin
            ...
            if (clr_corr_cnt) begin
                set_field_by_apb("CTL_RDLKECCCORRCNTCLR", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
                `uvm_info(get_full_name(), "RdLkeccCorrCntClr written to clear correctable error counter", UVM_LOW);
                set_field_by_apb("CTL_RDLKECCCORRCNTCLR", 1'b0, `CTL0_BASE_ADDR+i*'h0_0400);
            end

            // Clear uncorrectable counter
            if (clr_uncorr_cnt) begin
                set_field_by_apb("CTL_RDLKECCUNCORRCNTCLR", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
                `uvm_info(get_full_name(), "RdLkeccUncorrCntClr written to clear uncorrectable error counter", UVM_LOW);
                set_field_by_apb("CTL_RDLKECCUNCORRCNTCLR", 1'b0, `CTL0_BASE_ADDR+i*'h0_0400);
            end

            // Clear correctable interrupt
            if (clr_corr_int) begin
                set_field_by_apb("CTL_RDLKECCCORRINTCLR", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
                `uvm_info(get_full_name(), "RdLkeccCorrIntClr written to clear correctable interrupt", UVM_LOW);
                set_field_by_apb("CTL_RDLKECCCORRINTCLR", 1'b0, `CTL0_BASE_ADDR+i*'h0_0400);
            end

            // Clear uncorrectable interrupt
            if (clr_uncorr_int) begin
                set_field_by_apb("CTL_RDLKECCUNCORRINTCLR", 1'b1, `CTL0_BASE_ADDR+i*'h0_0400);
                `uvm_info(get_full_name(), "RdLkeccUncorrIntClr written to clear uncorrectable interrupt", UVM_LOW);
                set_field_by_apb("CTL_RDLKECCUNCORRINTCLR", 1'b0, `CTL0_BASE_ADDR+i*'h0_0400);
            end
        end
    end
