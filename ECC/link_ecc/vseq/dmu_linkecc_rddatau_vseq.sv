 ...
 * @Date: 2026-04-01 21:46:00
 * @LastEditors: fengqingwei
 * @LastEditTime: 2026-06-02 18:10:54
 * @Descripttion: 
 * @Version: 1.0
 * @Copyright (c) 2026 Phytium.co.Ltd
 */

class dmu_linkecc_rddatau_vseq extends dmu_base_vseq;

  `uvm_object_utils(dmu_linkecc_rddatau_vseq)
  ...
  virtual task body();
    ...
    // mr read test
    `uvm_info(get_full_name(), "Start dmu_linkecc_rddatau_vseq...", UVM_LOW)
    ...
    `uvm_info(get_full_name(), "dmu_linkecc_rddatau_vseq complete", UVM_LOW)
