 ...
 * @Date: 2026-04-02 19:15:51
 * @LastEditors: fengqingwei
 * @LastEditTime: 2026-06-02 18:14:31
 * @Descripttion: 
 * @Version: 1.0
 * @Copyright (c) 2026 Phytium.co.Ltd
 */

class dmu_linkecc_wr_masku_vseq extends dmu_base_vseq;

  `uvm_object_utils(dmu_linkecc_wr_masku_vseq)
  ...
  function new(string name="dmu_linkecc_wr_masku_vseq");
    super.new(name);
  endfunction
  ...
  virtual task body();
    ...
    // mr read test
    `uvm_info(get_full_name(), "Start dmu_linkecc_wr_masku_vseq...", UVM_LOW)
    ...
    `uvm_info(get_full_name(), "dmu_linkecc_wr_masku_vseq complete", UVM_LOW)
