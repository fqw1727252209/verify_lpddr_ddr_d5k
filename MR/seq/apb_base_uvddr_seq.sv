...
class apb_base_uvddr_seq extends apb_base_seq;
    ...
    task sw_mpc_flow(int ch_id=`0, input int mpc_dat, input int mpc_rk);
        ...
        if(mpc_trig || mpc_busy) begin
            ...
            `uvm_info(get_full_name(), $sformatf("%0t, sw_mpc_flow done, ch_id is %0d, mpc_dat is %0h, mpc_rk is %0h",$time, ch_id, mpc_dat, mpc_rk),UVM_LOW);
        end
    endtask : sw_mpc_flow

    task mr4_en_flow(int ch_id=`0, input int mr4_rd_inter, input bit[3:0] cs);
    ...
    task fgr_flow( input bit[1:0] ref_mode, int freq_point);//ref_mode:0,normal;1,fgr
        ...
        get_field_by_apb("CTL_MCMASTEREN", rdata, `1);
        if(rdata==1) begin
            master_ch = 0;
        end else begin
            master_ch = 1;
        ...
        set_field_by_apb("CTL_XMUHOLD", 1'b1,`1);
        set_field_by_apb("CTL_XMUHOLD", 1'b1,`2);
        set_field_by_apb("CTL_SWDRAINQUEUEEN", 1'b1,`1);
        set_field_by_apb("CTL_SWDRAINQUEUEEN", 1'b1,`2);

        $display($psprintf("%0t, fgr_flow step 2",$time));
        wait_field_2ch("CTL_MCIDLE", 1'b1, `1);
        wait_field_2ch("CTL_MCIDLE", 1'b1, `2);

        $display($psprintf("%0t, fgr_flow step 3",$time));
        set_field_by_apb("CTL_DRAINREFBEFORESRE", 1'b1,`1);
        set_field_by_apb("CTL_DRAINREFBEFORESRE", 1'b1,`2);

        if(master_ch==0) begin
            $display($psprintf("%0t, fgr_flow step 4",$time));
            set_field_by_apb("CTL_FGRSTART", 1'b1, `1);

            $display($psprintf("%0t, fgr_flow step 5",$time));
            wait_field_2ch("CTL_ARBSTATE", 'h200, `1);
        end else begin
            $display($psprintf("%0t, fgr_flow step 4",$time));
            set_field_by_apb("CTL_FGRSTART", 1'b1, `2);

            $display($psprintf("%0t, fgr_flow step 5",$time));
            wait_field_2ch("CTL_ARBSTATE", 'h200, `2);
        end

        set_field_by_apb("CTL_FREQACCEPOINT", freq_point);
        get_field_by_apb("CTL_MR4VALUE", mr4_value_ch0, `1);
        get_field_by_apb("CTL_MR4VALUE", mr4_value_ch1, `2);

        $display($psprintf("%0t, fgr_flow step 6",$time));
        if(master_ch==0) begin
            set_field_by_apb("CTL_SRTYPE", 1'b1, `1);
            set_field_by_apb("CTL_SRTRIG", 1'b1, `1);
            wait_field_2ch("CTL_SRTRIG", 1'b0, `1);
            wait_field_2ch("CTL_SRBUSY", 1'b0, `1);
        end else begin
            set_field_by_apb("CTL_SRTYPE", 1'b1, `2);
            set_field_by_apb("CTL_SRTRIG", 1'b1, `2);
            wait_field_2ch("CTL_SRTRIG", 1'b0, `2);
            wait_field_2ch("CTL_SRBUSY", 1'b0, `2);
        end

        $display($psprintf("%0t, fgr_flow step 7",$time));
        if(master_ch==0) begin
            wait_field_2ch("CTL_DDRLPSTATE", 2, `1);
        end else begin
            wait_field_2ch("CTL_DDRLPSTATE", 2, `2);
        end

        $display($psprintf("%0t, fgr_flow step 8",$time));
        mr4_value_ch0[4] = ref_mode;
        mr4_value_ch1[4] = ref_mode;
        set_field_by_apb("CTL_REFMODE", ref_mode, `1);
        set_field_by_apb("CTL_REFMODE", ref_mode, `2);
        for(int i=0; i<`CLK_DMU_FREQ_NUM; i++) begin
            set_field_by_apb("CTL_FREQACCEPOINT", i);
            set_field_by_apb("CTL_MR4VALUE", mr4_value_ch0, `1);
            set_field_by_apb("CTL_MR4VALUE", mr4_value_ch1, `2);
        end
        set_field_by_apb("CTL_FREQACCEPOINT", freq_point);

        $display($psprintf("%0t, fgr_flow step 9",$time));
        if(master_ch==0) begin
            set_field_by_apb("CTL_SRTYPE", 1'b0, `1);
            set_field_by_apb("CTL_SRTRIG", 1'b1, `1);
            wait_field_2ch("CTL_SRTRIG", 1'b0, `1);
            wait_field_2ch("CTL_SRBUSY", 1'b0, `1);

            $display($psprintf("%0t, fgr_flow step 10",$time));
            set_field_by_apb("CTL_FGRSTART", 1'b0, `1);
        end else begin
            set_field_by_apb("CTL_SRTYPE", 1'b0, `2);
            set_field_by_apb("CTL_SRTRIG", 1'b1, `2);
            wait_field_2ch("CTL_SRTRIG", 1'b0, `2);
            wait_field_2ch("CTL_SRBUSY", 1'b0, `2);

            $display($psprintf("%0t, fgr_flow step 10",$time));
            set_field_by_apb("CTL_FGRSTART", 1'b0, `2);
        end

        $display($psprintf("%0t, fgr_flow step 11",$time));
        set_field_by_apb("CTL_XMUHOLD", 1'b0,`1);
        set_field_by_apb("CTL_XMUHOLD", 1'b0,`2);
        set_field_by_apb("PUM_TOP_DFIREQSTATE", ref_mode,`1);
        set_field_by_apb("PUM_TOP_DFIREQSTATE", ref_mode,`2);
        set_field_by_apb("PUM_TOP_REFMODE", ref_mode,`1);
        set_field_by_apb("PUM_TOP_REFMODE", ref_mode,`2);
    ...
    task fgr_flow_all(input bit ref_ab1_sb0, input bit[1:0] ref_mode);//ref_mode:0,normal;1,fgr
        ...
        polling_periodic_sw_event(`1);
        polling_periodic_sw_event(`2);

        set_field_by_apb("CTL_FGRSTART", 1, `1);
        set_field_by_apb("CTL_FGRSTART", 1, `2);
        wait_field_2ch("CTL_ARBSTATE", 1, `1);
        wait_field_2ch("CTL_ARBSTATE", 1, `2);
        wait_field_2ch("CTL_ARBSTATE", 1, `1);
        wait_field_2ch("CTL_ARBSTATE", 1, `2);

        get_field_by_apb("CTL_DFILPENSR", dfilpensr0, `1);
        get_field_by_apb("CTL_DFILPENSR", dfilpensr1, `2);
        get_field_by_apb("CTL_SDRAMCGENSRDEEP", sdramcgen0, `1);
        get_field_by_apb("CTL_SDRAMCGENSRDEEP", sdramcgen1, `2);
        set_field_by_apb("CTL_DFILPENSR", 0, `1);
        set_field_by_apb("CTL_DFILPENSR", 0, `2);
        set_field_by_apb("CTL_SDRAMCGENSRDEEP", 0, `1);
        set_field_by_apb("CTL_SDRAMCGENSRDEEP", 0, `2);
        sr_entry_all();
        set_field_by_apb("CTL_REFMODE", ref_mode, `1);
        set_field_by_apb("CTL_REFMODE", ref_mode, `2);
        ...
        begin
            ...
            int mr4_0;
            int mr4_1;
            get_field_by_apb("CTL_REFSWEN", refswen0, `1);
            get_field_by_apb("CTL_REFSWEN", refswen1, `2);
            if(refswen0 == 1 || refswen1 == 1) begin
                `uvm_info(get_full_name(), $sformatf("%0t, refswen is not 0, mode only can be refab",$time),UVM_LOW);
            end else begin
                set_field_by_apb("CTL_REFABREQEN", ref_ab1_sb0, `1);
                set_field_by_apb("CTL_REFABREQEN", ref_ab1_sb0, `2);
                get_field_by_apb("CTL_RFMEN", rfm_en0, `1);
                get_field_by_apb("CTL_RFMEN", rfm_en1, `2);
                if(rfm_en0 == 1 && rfm_en1 == 1)begin
                    set_field_by_apb("CTL_RFMABEN", ref_ab1_sb0, `1);
                    set_field_by_apb("CTL_RFMABEN", ref_ab1_sb0, `2);
                end
                else begin
                    `uvm_info(get_full_name(),"channel0/1 RFM function has not enable",UVM_LOW);
                end
            end
            get_field_by_apb("CTL_MR4VALUE", mr4_0, `1);
            get_field_by_apb("CTL_MR4VALUE", mr4__1, `2);
            mr4_0[4] = ref_mode;
            mr4_1[4] = ref_mode;
            set_field_by_apb("CTL_MR4VALUE", mr4_0, `1);
            set_field_by_apb("CTL_MR4VALUE", mr4_1, `2);
        end

        sr_exit_all();
        wait_field_2ch("CTL_SWOPBUSY", 0, `1);
        wait_field_2ch("CTL_SWOPBUSY", 0, `2);
        set_field_by_apb("CTL_PDNEN", pdnen0, `1);
        set_field_by_apb("CTL_PDNEN", pdnen1, `2);
        set_field_by_apb("CTL_SREN", sren0, `1);
        set_field_by_apb("CTL_SREN", sren1, `2);
        set_field_by_apb("CTL_DFILPENSR", dfilpensr0, `1);
        set_field_by_apb("CTL_DFILPENSR", dfilpensr1, `2);
        set_field_by_apb("CTL_SDRAMCGENSRDEEP", sdramcgen0, `1);
        set_field_by_apb("CTL_SDRAMCGENSRDEEP", sdramcgen1, `2);
        unhold_xmu_uif(`1);
        unhold_xmu_uif(`2);
        set_field_by_apb("CTL_FGRSTART", 0, `1);
        set_field_by_apb("CTL_FGRSTART", 0, `2);

    endtask : fgr_flow_all

    task hold_xmu_uif(int ch_id=`0);
        bit[31:0] rd_data;
    ...
    task exit_low_power_state(int ch_id=`0, output bit pdnen, output bit sren);
        bit swmpsm;
    ...
    task exit_low_power_state_all(output bit pdnen0, output bit pdnen1, output bit sren0, output bit sren1);
        ...
        get_field_by_apb("CTL_PDNEN", pdnen0, `1);
        get_field_by_apb("CTL_PDNEN", pdnen1, `2);
        get_field_by_apb("CTL_SREN", sren0, `1);
        get_field_by_apb("CTL_SREN", sren1, `2);
        set_field_by_apb("CTL_PDNEN", 0, `1);
        set_field_by_apb("CTL_PDNEN", 0, `2);
        set_field_by_apb("CTL_SREN", 0, `1);
        set_field_by_apb("CTL_SREN", 0, `2);

        sr_exit_all();

        get_field_by_apb("CTL_SWMPSM", swmpsm0, `1);
        get_field_by_apb("CTL_SWMPSM", swmpsm1, `2);
        if(swmpsm0 == 1 && swmpsm1 == 1) begin
            mpsmx_flow(`1);
            mpsmx_flow(`2);
            set_field_by_apb("CTL_SWCMDSTART", 0, `1);
            set_field_by_apb("CTL_SWCMDSTART", 0, `2);
        end

        wait_field_2ch("CTL_DDRLPSTATE", 0, `1);
        wait_field_2ch("CTL_DDRLPSTATE", 0, `2);
    endtask : exit_low_power_state_all

    task mpsmx_flow(int ch_id=`0);
        int mr2_value;
    ...
    task sr_exit_all();
        ...
        wait_field_2ch("CTL_SRTRIG", 0, `1);
        wait_field_2ch("CTL_SRBUSY", 0, `1);
        //wait_field_2ch("CTL_SRTRIG", 0, `2);
        //wait_field_2ch("CTL_SRBUSY", 0, `2);

        get_field_by_apb("CTL_SWSR", swsr, `1);
        //get_field_by_apb("CTL_SWSR", swsr_ch1, `2);

        if(swsr == 1) begin
        //if(swsr == 1 && swsr_ch1 == 1) begin
            set_field_by_apb("CTL_SRTYPE", 0, `1);
            set_field_by_apb("CTL_SRTRIG", 1, `1);
            //set_field_by_apb("CTL_SRTYPE", 0, `2);
            //set_field_by_apb("CTL_SRTRIG", 1, `2);
    ...
    task polling_periodic_sw_event(int ch_id=`0);
        wait_field_2ch("CTL_MPCTRIG", 0, ch_id);
        wait_field_2ch("CTL_MPCBUSY", 0, ch_id);
    ...
    task sr_entry_all();
        ...
        //  if(swsr == 0 && swsr_ch1 == 0) begin
            set_field_by_apb("CTL_SRTYPE", 1, `1);
            set_field_by_apb("CTL_SRTRIG", 1, `1);
            //set_field_by_apb("CTL_SRTYPE", 1, `2);
            //set_field_by_apb("CTL_SRTRIG", 1, `2);
    ...
    task wait_field_2ch(input string field_name, input int need_state, int ch_id=`0);
        int state;
        while(1) begin
    ...
    task unhold_xmu_uif(int ch_id=`0);
        set_field_by_apb("CTL_UIFHOLD", 0, ch_id);
        set_field_by_apb("CTL_XMUHOLD", 0, ch_id);
    endtask : unhold_xmu_uif

    task mrr_handle(int ch_id, input bit[3:0] mrrank, input bit[8:0] mraddr, output bit[63:0] mrdat, output bit[15:0] mrdatecc);
        set_field_by_apb("CTL_MRRANK", mrrank, ch_id);
        ...
        //wait_field_2ch("CTL_MRRDATVLD", 1,ch_id); //0822 version add

// -------------------------------------------------------------------------
// --- 注意：此处存在代码截断（第443行至第484行在您上传的图片中缺失） ---
// ---       请您在实际工程中自行补充这部分确实的内容                    ---
// -------------------------------------------------------------------------

        $display($psprintf("%0t, mrw_flow done, ch_id is %0h, mrrank is %0h, mraddr is %0h, mrdat is %0h",$time, ch_id, mrrank, mraddr, mrdat));
    endtask : mrw_flow

    task disable_auto_cmd(int ch_id=`0, output bit zq, output bit ctrlupd, output bit mrr4);
    ...
    task sw_mpsm_flow(int ch_id=`0, input bit[1:0] mpsm_state);
    ...
    task ppr_source_check(int ch_id=`0, bit[3:0] cs, bit[3:0] cid, bit[2:0] bg, output [79:0] ppr_src);
        bit [7:0] mr14;
        ...
        get_field_by_apb("CTL_MRRDAT0",    ppr_src[31:0], ch_id);
        get_field_by_apb("CTL_MRRDAT1",    ppr_src[63:32], ch_id);
        get_field_by_apb("CTL_MRRDATECC",  ppr_src[79:64], ch_id);
    ...
    task ppr_guard_key(int ch_id=`0, bit[3:0] cs);
    ...
    task ppr_wrdata_gen(int ch_id=`0, int device_id, int mem_width);
        bit[31:0] wr_data_dq;
    ...
    task ppr_recovery_procedure(int ch_id=`0, bit sren, bit pdnen, bit zq, bit ctrlupd, bit mrr4);
    ...
    task sce_send_cmd(int ch_id=`0, bit cmd_code, bit[7:0] cmd_type, bit[31:0] cmd_body, bit seq_last, bit ongoing);
        bit cmd_err;
    ...
    task sce_pause_ref(int ch_id=`0, bit[3:0] cs, bit seq_last, bit ongoing);
        bit[31:0] cmd_body;
        cmd_body[0] = 1;
        cmd_body[1] = 0;
        cmd_body[26:23] = cs;
    ...
    task sce_preab_all_lk(int ch_id=`0, bit[3:0] cs);
        bit[31:0] cmd_body;
        cmd_body[10] = 0;
        cmd_body[26:23] = cs;
    ...
    task sce_resume_ref(int ch_id=`0, bit[3:0] cs, bit seq_last, bit ongoing);
        bit[31:0] cmd_body;
        cmd_body[0] = 0;
        cmd_body[26:23] = cs;
    ...
    task pll_ctrl_setting(input int freq);
        ...
        set_field_by_apb("PUM_TOP_PLLCTRL", pll_ctrl, `0);
    ...
    task pll_bypass_setting;
        ...
        // get_field_by_apb("PUM_TOP_PLLCTRL", pll_ctrl, `0);
        // // pll_ctrl = {pll_vcosel,pll_postdiv,pll_fbdiv,pll_refdiv,pll_bypass,pll_pdcal,1'b1};
        // pll_ctrl[2]=1'b1;
        // set_field_by_apb("PUM_TOP_PLLCTRL", pll_ctrl, `0);
        set_field_by_apb("PUM_TOP_PLLBYPMODE", 1'b1, `0);
    endtask: pll_bypass_setting

    task ctrlupd_flow(int ch_id=`0,input bit hw0_sw1,input int sw_cnt);
        bit ctrlupd_en;
        bit pdnen, sren;
        ...
        if(hw0_sw1) begin
            for(int i=0; i<sw_cnt; i++) begin
                ...
                set_field_by_apb("CTL_CTRLUPDTRIG", 1, ch_id);
                wait_field_2ch("CTL_CTRLUPDBUSY", 0, ch_id);
                `uvm_info(get_type_name(),$sformatf("%0t,  sw_ctrlupd_flow done, ch_id is %0d, sw_cnt is %0d",$time, ch_id, sw_cnt),UVM_LOW);
            end
        end else begin
            `uvm_info(get_type_name(),$sformatf("%0t,  hw_ctrlupd_flow done, ch_id is %0d",$time, ch_id),UVM_LOW);
        end
    ...
    task change_to_normal_ref_flow_2ch;
        bit[1:0] ref_mode;
        get_field_by_apb("CTL_REFMODE", ref_mode, `1);
        if(ref_mode != 0) begin
            fgr_flow(0,0);
        end
        get_field_by_apb("CTL_REFMODE", ref_mode, `2);
        if(ref_mode != 0) begin
            fgr_flow(0,0);
        end
    endtask

    task ctrl_cww_test(input bit[8:0]RCD_BIT,input bit[3:0]MR_RANK,input bit[15:0] CWW_DAT,int ch_id);
        ...
        RCD_BIT[8]='b1;
        set_field_by_apb("CTL_MRADDR", RCD_BIT, ch_id);
        set_field_by_apb("CTL_MRRANK", MR_RANK, ch_id);
        set_field_by_apb("CTL_MRWDAT", CWW_DAT, ch_id);
    ...
    task ctrl_cwr_test(input bit[8:0]RCD_BIT,input bit[3:0]MR_RANK,int ch_id,input bit[7:0]MR_OP);
        ...
        set_field_by_apb("CTL_MRTYPE", 0, ch_id);
        set_field_by_apb("CTL_MRADDR", 'h15E, ch_id);
        set_field_by_apb("CTL_MRWDAT", RCD_BIT, ch_id);
        set_field_by_apb("CTL_MRTRIG", 1, ch_id);
        ...
        set_field_by_apb("CTL_MRRANK", MR_RANK, ch_id);
        set_field_by_apb("CTL_MRTYPE", 0, ch_id);
        set_field_by_apb("CTL_MRADDR", 'h3F, ch_id);
        set_field_by_apb("CTL_MRTRIG", 1, ch_id);
        ...
        wait_field_2ch("CTL_MRTRIG", 0, ch_id);
        wait_field_2ch("CTL_MRBUSY", 0, ch_id);
        get_field_by_apb("CTL_MRRDAT0", cwr_data[31:0], ch_id);
    ...
    task actbyp_config();
        ...
        if (rdata==1) begin
            set_field_by_apb("CTL_RDOOPPOSITEACTEN", 1, `1);
            set_field_by_apb("CTL_WROPPOSITEACTEN", 1, `1);
        end

        get_field_by_apb("schedul_policy_ch1", rdata, `DMU_USR_BASE_ADDR>>2);
        if (rdata==1) begin
            set_field_by_apb("CTL_RDOOPPOSITEACTEN", 1, `2);
            set_field_by_apb("CTL_WROPPOSITEACTEN", 1, `2);
        end
    ...
    task param_chi_qos_wr_region0_thre_set(int value);
        reg [31:0] rdata;
        USR_REGRD(`CHIP0_BASE_ADDR + `CHI_QOS_WR_REGION0_THREH_ADDR, rdata);
        rdata[3:0] = value; // param_chi_qos_wr_region0_thre_ch0
        USR_REGWR(`CHIP0_BASE_ADDR + `CHI_QOS_WR_REGION0_THREH_ADDR, rdata);
        USR_REGRD(`CHIP1_BASE_ADDR + `CHI_QOS_WR_REGION0_THREH_ADDR, rdata);
        rdata[3:0] = value; // param_chi_qos_wr_region0_thre_ch1
        USR_REGWR(`CHIP1_BASE_ADDR + `CHI_QOS_WR_REGION0_THREH_ADDR, rdata);
    ...
    task param_chi_port_expired_check_en_set(int value);
        ...
        USR_REGRD(`CHIP1_BASE_ADDR + `CHI_EXPIR_AGE_EN_ADDR, rdata);
        rdata[1] = value; // param_protq_hpr_min_ch1
        USR_REGWR(`CHIP1_BASE_ADDR + `CHI_EXPIR_AGE_EN_ADDR, rdata);
