class dmu_swerror_ecc_scbr_patrol_vseq extends dmu_base_vseq;

    `uvm_object_utils(dmu_swerror_ecc_scbr_patrol_vseq)
    `uvm_declare_p_sequencer(my_vsqr)

    function new(string name="dmu_swerror_ecc_scbr_patrol_vseq");
        super.new(name);
    endfunction
    ...
    virtual task body();
        ...
        for(int i = 0; i < 20 ; i++)begin
            ...
            //
            // gen_err_row={gen_addr[31],gen_addr[30],gen_addr[28],gen_addr[16],gen_addr[8],gen_addr[13],gen_addr[23],gen_addr[26],gen_addr[3],gen_addr[5],gen_addr[12],gen_addr[11],gen_addr[0],gen_addr[17],gen_addr[22],gen_addr[4],gen_addr[20],gen_addr[6],gen_addr[19],gen_addr[21],gen_addr[15],gen_addr[29],gen_addr[1],gen_addr[14]};
            // gen_err_ba={gen_addr[29],gen_addr[2],gen_addr[27],gen_addr[7]};
        ...
        `uvm_do_on_with(ecc_scrub_seq,p_sequencer.apb_sqr_[0],{ecc_scrub_seq.mode==0;ecc_scrub_seq.scrub_mode==3'b100;start_addr==0;end_addr==40;});
        fork
        begin
    ...
    virtual task post_body();
        ...
        `uvm_do_on_with(ras_apb_seq,p_sequencer.apb_sqr_[0],{ras_apb_seq.int_trig_mode==1'b1;ras_apb_seq.int_select=='h0600c00;});
        if(starting_phase) starting_phase.drop_objection(this);
    endtask
endclass