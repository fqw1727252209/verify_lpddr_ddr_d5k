class dmu_swerror_ecc_scbr_rmw_vseq extends dmu_base_vseq;

    `uvm_object_utils(dmu_swerror_ecc_scbr_rmw_vseq)
    `uvm_declare_p_sequencer(my_vsqr)

    function new(string name="dmu_swerror_ecc_scbr_rmw_vseq");
        super.new(name);
    endfunction
    ...
    virtual task body();
        ...
        `uvm_do_on_with(ecc_scrub_seq,p_sequencer.apb_sqr_[0],{ecc_scrub_seq.mode==0;ecc_scrub_seq.scrub_mode==3;start_addr==0;end_addr==20;});
        ...
        //rd scrub mode
        `uvm_info(get_full_name(), "Start ecc_scrub set...", UVM_LOW);
        `uvm_do_on_with(ecc_scrub_seq,p_sequencer.apb_sqr_[0],{ecc_scrub_seq.mode==0;ecc_scrub_seq.scrub_mode==0;start_addr=='hffff000;end_addr=='hffff0ff;});
